...
export const withIosGoogleCast = (config, props) => {
...
export const MATCH_INIT = /-\s*\(BOOL\)\s*application:\s*\(UIApplication\s*\*\s*\)\s*\w+\s+didFinishLaunchingWithOptions:/g;
export function addGoogleCastAppDelegateDidFinishLaunchingWithOptions(src, {
...
export function addSwiftGoogleCastAppDelegateDidFinishLaunchingWithOptions(src, {
  ...
  return insertContentsInsideSwiftFunctionBlock(src, 'application(_:didFinishLaunchingWithOptions:)', newSrc.join('\n'), {
